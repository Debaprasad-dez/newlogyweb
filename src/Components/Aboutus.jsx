    ...
    <div className="pt-5">
      ...
      <div className="container mb-5">
        <div className="row">
          ...
          <div className="col-md-6 clientsmq ">
            <div class="marquee1">
              <div class="marquee--inner">
                <div className="span">
                  <div className="row m-0 p-0">
                    <div className="col p-0">
                      <div className="client-box1 bg-white border">
                        <img src={LogoFree} className="w-75 mx-auto" alt="" />
                      </div>
                    </div>
                    <div className="col p-0">
                      <div className="client-box1 bg-white border">
      ...
      <div className="container">
        <div className="row ">
          ...
          <div className="col-md-6">
            <div className="patentblock">
              <div className="patentcard bg-grad">
                <div className="patentimg">
                  <img src={patent} className="w-100" alt="" />
                </div>
                <div className="patentText">
                  <h6 className="p-0 m-0">patent name</h6>
                  <p className="small">extra info</p>
                </div>
              </div>
              <div className="patentcard bg-grad">
                <div className="patentimg">
